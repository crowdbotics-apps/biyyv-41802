"""
Django settings for biyyv_41802 project.
...
WSGI_APPLICATION = 'biyyv_41802.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "biyyv_41802 API",
    "DESCRIPTION": "API documentation for biyyv_41802 App",
    "VERSION": "v1",
}
